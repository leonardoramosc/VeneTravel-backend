...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "/home/leonardo/Documents/node/natour",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibGVvcnJjIiwiYSI6ImNrdTJyYW95ajE0OTEydXFyemY5OXlhcnIifQ.LiuRx4U-qGo6QavObqfo1w';
...
if (userDataForm) {
  userDataForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var userName, userEmail, _yield$updateUserData, name, email;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 3;
              _context.next = 6;
              return (0, _updateSettings.updateUserData)(userName.value, userEmail.value);

            case 6:
              _yield$updateUserData = _context.sent;
              name = _yield$updateUserData.name;
              email = _yield$updateUserData.email;
              userName.value = name;
